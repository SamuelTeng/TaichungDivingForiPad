//
//  Forecast_ToursiteViewController.m
...
@interface Forecast_ToursiteViewController (){
...
@implementation Forecast_ToursiteViewController
...
-(void)loadView
{
    ...
    NSString *addressString = @"http://www.cwb.gov.tw/V7/life/Entertainment.htm";
